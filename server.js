...
{
	db.query('select projection, month, projects.project, projects.title, resources.resource, resources.last, resources.first, hours, projects.project_status from projections, projects, resources where projections.project=projects.project and resources.resource = projections.resource and month > "2016-12-01" order by resources.department desc, resources.last desc, resources.first desc, projects.project_status, projects.title desc, month;').then(
		function( data )
		{
			res.status(200).json(
			{
